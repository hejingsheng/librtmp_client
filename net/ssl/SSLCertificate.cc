...
static SSLCertificate *sslCert;
static bool isInit = false;
void SSLCertificate::InitSSLCertificate(bool ecdsa)
{
	if (!isInit)
	{
		sslCert = new SSLCertificate(ecdsa);
		sslCert->init();
		isInit = true;
	}
}

SSLCertificate* SSLCertificate::getSSLCert()
{
	return sslCert;
}
